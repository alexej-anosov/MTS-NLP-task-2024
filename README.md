...
Это даст возможность прооводить много экспериментов, например со структурой промпта, фреймворком деятельности агента (Reflecxion, ExpeL), различными моделями в качестве основы.
