...
| get flights  | Позволяет получить возможные рейсы. В качестве параметров передаются критерии фильтрации датасетов, а также способ сортировки (подробнее возможные параметры можно посмотреть в файле ./src/tools) |
