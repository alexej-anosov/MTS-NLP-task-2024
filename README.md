...
Это даст возможность прооводить много экспериментов, например со структурой промпта, фреймворком поведения агента (Tree of thougths, Reflexion, ExpeL), различными моделями в качестве основы.
